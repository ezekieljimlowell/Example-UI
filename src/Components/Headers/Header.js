...
export const Header = () => {
    ...
    const inspiration = (
        <div className={Styles.inspirationPopup}>
            <div>
    ...
    const dipslayMenu = (
        <Menu
            ...
            items={[
                {
                    label: <Button>Inspiration</Button>,
                    key: 0
                },
                {
                    label: <Button>Find work</Button>,
                    key: 1
                },
                {
                    label: <Button>Learn Design</Button>,
                    key: 2
                },
                {
                    label: <Button>Go Pro</Button>,
                    key: 3
                },
                {
                    label: <Button>Marketplace</Button>,
                    key: 4
                },
                {
                    label: <Button>Hire Designers</Button>,
                    key: 5
                }
            ]}
        />
        ...
        <div>
            <nav className={Styles.navBar}>
                <div className={Styles.leftSideElements}>
                    <a href="#" className={Styles.iconDribble}>
                    ...
                    <Popover className={Styles.popover} content={inspiration} trigger="hover">
                ...
                <Dropdown className={Styles.menuBar} overlay={dipslayMenu} placement="bottom" trigger={["click"]}>
                    <Button>
                        <svg className={Styles.menuIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 16" fill="none" role="img">
                ...
                <div className={Styles.imageBackground}>
                    <div className={Styles.beforeContent}>
                        <div className={Styles.imageContainer}>
                            <picture>
                                <source type="image/webp" sizes="(max-width: 860px) 400px, 620px" srcSet="https://cdn.dribbble.com/assets/searches/search-header-400-525078f3da803f32fbe7efc35d01bd654d003c93ad85e5092cbeccbf892bbaab.webp 400w, https://cdn.dribbble.com/assets/searches/search-header-800-67646da500269df6cebd97c90b7d044d714745e368fe4e91ecb3e16e3a7f790e.webp 800w, https://cdn.dribbble.com/assets/searches/search-header-620-71a539f3202d1ffa55f1f8684897ce42b7f5e35e94f4d276a1319764039c87ad.webp 620w, https://cdn.dribbble.com/assets/searches/search-header-1220-c3eb51aab89988bb6722f3a36e91a9bc9c1ecec68ded2e713610247b589c8ba2.webp 1240w"></source>
                                <source type="image/png" sizes="(max-width: 860px) 400px, 620px" srcSet="https://cdn.dribbble.com/assets/searches/search-header-400-a40f5b2d953007882ea557c30f11e58eb50e49a2fdb7476ab747cb03d06d0dbb.png 400w, https://cdn.dribbble.com/assets/searches/search-header-800-1f49142870a5c1428edf0f570465ce9114ca4dc76f9d645bcf5c786a18dc697f.png 800w, https://cdn.dribbble.com/assets/searches/search-header-620-ef14484efe06f8675ea0b3b90642e4aa9afdda6c2ec2352346a6a718dbea191f.png 620w, https://cdn.dribbble.com/assets/searches/search-header-1220-4fe74e874cdf583bbac4386ec4522183210907de406153c0f68e2a124b14b79c.png 1240w"></source>
                                <img width="400" height="236" className={Styles.faceImage} alt="Find designers and inspiration on Dribbble" src="https://cdn.dribbble.com/assets/searches/search-header-800-1f49142870a5c1428edf0f570465ce9114ca4dc76f9d645bcf5c786a18dc697f.png"></img>
                            </picture>
                        </div>
                        <div className={Styles.searchTextContainer}>
                            <h1 className={Styles.searchText}>Search Dribbble</h1>
                        </div>
                    </div>
                </div>
            </div>
